...
BOARD_USERDATAIMAGE_PARTITION_SIZE := 240941772800
BOARD_VENDOR_BOOTIMAGE_PARTITION_SIZE := 100663296

BOARD_PREBUILT_ODMIMAGE := $(PSYCHE_PREBUILT)/odm.img
BOARD_PREBUILT_VENDORIMAGE := $(PSYCHE_PREBUILT)/vendor.img

BOARD_PSYCHE_DYNAMIC_PARTITIONS_PARTITION_LIST := product system system_ext vendor
BOARD_SUPER_PARTITION_SIZE := 9126805504
BOARD_SUPER_PARTITION_GROUPS := psyche_dynamic_partitions
BOARD_PSYCHE_DYNAMIC_PARTITIONS_SIZE := 9122611200

BOARD_PARTITION_LIST := $(call to-upper, $(BOARD_PSYCHE_DYNAMIC_PARTITIONS_PARTITION_LIST))
