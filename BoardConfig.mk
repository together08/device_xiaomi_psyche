...
TARGET_RECOVERY_UI_MARGIN_HEIGHT := 163
...
TARGET_RECOVERY_DEVICE_MODULES := libinit_psyche
...
TARGET_PREBUILT_KERNEL := $(PSYCHE_PREBUILT)/kernel/kernel
...
BOARD_PSYCHE_DYNAMIC_PARTITIONS_PARTITION_LIST := odm product system system_ext vendor
